 ...
 * @author urreg
 */
public class ManageLogisticFrame2 extends JInternalFrame {
    private final LogisticService logisticService;
    private final JDesktopPane desktopPane;
    private JTable logisticTable;
    private DefaultTableModel tableModel;

    public ManageLogisticFrame2(LogisticService logisticService, JDesktopPane desktopPane) {
    ...
    private void openCreateForm() {
        LogisticFormFrame form = new LogisticFormFrame(logisticService, null, this::loadLogistics);
    ...
    private void openUpdateForm() {
        ...
        LogisticFormFrame form = new LogisticFormFrame(logisticService, logistic, this::loadLogistics);
        desktopPane.add(form);
        form.setVisible(true);
    }
