...
public class ManagerEvent extends javax.swing.JInternalFrame {
    ...
    // El servicio lo crea Main una sola vez y se comparte (igual que "servicio"
    // en el ejemplo MDI), así todas las ventanas ven los mismos eventos.
    ...
    public ManagerEvent(EventService service) {
        ...
        // (sin esto la ventana no tendría título ni se podría cerrar)
    ...
    // ------------------------------------------------------------------
    // Código propio (fuera de las zonas generadas por NetBeans)
    // ------------------------------------------------------------------

    // Reemplaza el modelo de ejemplo del diseñador (4 filas vacías y columnas
    // editables) por uno vacío y de solo lectura: los datos se editan desde el
    // formulario, no directamente en la tabla.
    ...
    // el formulario lo llama después de guardar.
    ...
    // Abre el formulario dentro del mismo JDesktopPane. event == null => crear.
    // (JInternalFrame ya trae getDesktopPane(), no hace falta pasar Main.)
